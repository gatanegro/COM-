...
def find_zeros_in_range(t_min, t_max, points=1000, epsilon=1e-5):
    """
...
def analyze_zero_spacing(zeros):
    ...
    normalized_spacings = spacings / avg_spacing if avg_spacing != 0 else np.array([])
...
def visualize_zero_spacing(zeros):
    ...
    if len(spacings) == 0:
        ...
        ax.text(0.5, 0.5, "No zeros found to analyze spacing", 
                ha='center', va='center', fontsize=14)
        ax.set_title('Zero Spacing Analysis')
        return fig
